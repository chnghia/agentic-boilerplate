...
export const MicIcon = ({ size = 16 }: { size?: number }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8 1C6.89543 1 6 1.89543 6 3V8C6 9.10457 6.89543 10 8 10C9.10457 10 10 9.10457 10 8V3C10 1.89543 9.10457 1 8 1ZM4.5 3C4.5 1.067 6.067 -0.5 8 -0.5C9.933 -0.5 11.5 1.067 11.5 3V8C11.5 9.933 9.933 11.5 8 11.5C6.067 11.5 4.5 9.933 4.5 8V3ZM3 7.25H4.5V8C4.5 9.933 6.067 11.5 8 11.5C9.933 11.5 11.5 9.933 11.5 8V7.25H13V8C13 10.4853 11.0899 12.5118 8.75 12.7324V14.5H11V16H5V14.5H7.25V12.7324C4.91015 12.5118 3 10.4853 3 8V7.25Z"
            fill="currentColor"
        />
    </svg>
);
...
export const ImageIcon = ({ size = 16 }: { size?: number }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M14.5 2.5H1.5V9.18933L4.21967 6.46967L4.75 5.93934L5.28033 6.46967L7.95096 9.14029L10.2197 6.87063L10.75 6.3403L11.2803 6.87063L14.5 10.0903V2.5ZM1.5 13.5V11.3107L4.75 8.06067L6.8896 10.2003L5.53033 11.5596L6.59099 12.6203L8.48032 10.731L10.75 12.9997L11.8107 11.939L14.5 14.5H1.5ZM0 1H1.5H14.5H16V2.5V13.5C16 14.8807 14.8807 16 13.5 16H2.5C1.11929 16 0 14.8807 0 13.5V2.5V1ZM11.5 6C12.3284 6 13 5.32843 13 4.5C13 3.67157 12.3284 3 11.5 3C10.6716 3 10 3.67157 10 4.5C10 5.32843 10.6716 6 11.5 6Z"
            fill="currentColor"
        />
    </svg>
);

// Daily Log icon - notepad/document with lines
export const NoteIcon = ({ size = 16 }: { size?: number }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M1.5 1.75C1.5 0.783502 2.2835 0 3.25 0H12.75C13.7165 0 14.5 0.783502 14.5 1.75V14.25C14.5 15.2165 13.7165 16 12.75 16H3.25C2.2835 16 1.5 15.2165 1.5 14.25V1.75ZM3.25 1.5C3.11193 1.5 3 1.61193 3 1.75V14.25C3 14.3881 3.11193 14.5 3.25 14.5H12.75C12.8881 14.5 13 14.3881 13 14.25V1.75C13 1.61193 12.8881 1.5 12.75 1.5H3.25ZM4.5 4H5.25H10.75H11.5V5.5H10.75H5.25H4.5V4ZM5.25 7.5H4.5V9H5.25H10.75H11.5V7.5H10.75H5.25ZM4.5 11H5.25H8.25H9V12.5H8.25H5.25H4.5V11Z"
            fill="currentColor"
        />
    </svg>
);

// Daily News icon - newspaper
export const NewspaperIcon = ({ size = 16 }: { size?: number }) => (
    <svg
        height={size}
        strokeLinejoin="round"
        viewBox="0 0 16 16"
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M0 2.5V12.5C0 13.8807 1.11929 15 2.5 15H13.5C14.8807 15 16 13.8807 16 12.5V4.5V3H14.5H13V2.5V1H12.25H0.75H0V2.5ZM1.5 2.5V12.5C1.5 13.0523 1.94772 13.5 2.5 13.5H11.5C11.5 13.5 11.5 4.5 11.5 2.5H1.5ZM13 4.5V12.5C13 13.0523 13.4477 13.5 14 13.5H13.5C14.0523 13.5 14.5 13.0523 14.5 12.5V4.5H13ZM3 4.5H3.75H7.25H8V6H7.25H3.75H3V4.5ZM3.75 7.5H3V9H3.75H5.25H6V7.5H5.25H3.75ZM3 10.5H3.75H7.25H8V12H7.25H3.75H3V10.5ZM9.25 7.5H8.5V12H9.25H10.25H11V7.5H10.25H9.25Z"
            fill="currentColor"
        />
    </svg>
);

// Daily Learning icon - open book
export const BookIcon = ({ size = 16 }: { size?: number }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8 2.59998C7.19249 1.92807 6.14851 1.5 5 1.5H1.5H0V3V12V13.5H1.5H5C5.93888 13.5 6.79002 13.8523 7.43311 14.4283L8 14.9361L8.56689 14.4283C9.20998 13.8523 10.0611 13.5 11 13.5H14.5H16V12V3V1.5H14.5H11C9.85149 1.5 8.80751 1.92807 8 2.59998ZM7.25 4.12602V12.4507C6.54558 12.0186 5.70282 11.75 4.79289 11.75H1.5V3H5C5.93888 3 6.79002 3.35233 7.25 4.12602ZM8.75 12.4507V4.12602C9.20998 3.35233 10.0611 3 11 3H14.5V11.75H11.2071C10.2972 11.75 9.45442 12.0186 8.75 12.4507Z"
            fill="currentColor"
        />
    </svg>
);

// Bookmarker icon - bookmark ribbon
export const BookmarkIcon = ({ size = 16 }: { size?: number }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M3 1H4.5H11.5H13V2.5V15.5L8 12L3 15.5V2.5V1ZM4.5 2.5V12.5L8 10L11.5 12.5V2.5H4.5Z"
            fill="currentColor"
        />
    </svg>
);